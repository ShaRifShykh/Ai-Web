  ...
  return (
    <div className="w-full relative xs:flex items-center justify-center lg:grid text-white grid-cols-2 place-items-center bg-[#302f2f] min-h-screen">
     ...
     <GoogleSign/>
          ...
          <form onSubmit={SubmitHandler} className="flex flex-col gap-2 py-4">
          ...
          <div>
            ...
            <p className=" lg:text-[1.1vw] text-center md:text-[2.2vw] sm:text-[3.3vw] xs:text-[3.2vw]">
              Forget password?{" "}
              <Link className="lg:text-[1.1vw]  md:text-[2.2vw] sm:text-[3.3vw] xs:text-[3.2vw] mt-2" to={"/dashboard/auth/forgetpassword"}>Reset</Link>
            </p>
          </div>
        </div>
      </div>
