...
const GeneratedVideo = ({ videoUrl , setIsVideoConentShow}) => {
    ...
    <div className="lg:w-[50vw] pt-[3vw] md:w-[93vw] text-white sm:w-[90vw] xs:w-[100vw] xs:ml-auto lg:mx-auto h-full ">
      ...
      <div className="flex justify-end">
        <div className="flex gap-6">
          ...
          <button onClick={()=>setIsVideoConentShow(false)} className="cursor-pointer py-2 px-5 rounded-lg lg:text-[0.8vw] xs:text-[3.4vw] bg-white-50 border border-gray-500">
            Close
          </button>
          <button
