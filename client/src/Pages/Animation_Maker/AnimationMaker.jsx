...
const AnimationMaker = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "AI Animation",
    headingPart2: "Generator",
    disc: "Generate animated videos using our AI animation video generator. Prompt your video idea, and our AI tool will write the script, generate visuals, add voiceovers, subtitles, and more.",
    button: "Get Started",
    creditText: null,
  ...
  let cardData = {
    MHP1: "Generate",
    MHP2: "text to animation with AI",
    cards: [
      {
        cardHeading: "Generate marketing animated videos",
        cardDisc:
          "Use our AI animation generator to create animated marketing videos that capture your audience's attention. Type your idea, and the tool will automatically generate visuals, voiceovers, and subtitles, streamlining your marketing efforts.",
        cardBtn: "Create Now",
        cardImg:
          "/imgs/AnimationMaker/Animator_content_creator_a3c7c1a44c.webp",
      },
      {
        cardHeading: "AI animation generator for content creation",
        cardDisc:
          "Enhance your content strategy with AI generated animations. Whether for YouTube, Instagram, or any other social media platform, invideo AI simplifies the process, delivering high-quality animations that align with your content goals.",
        cardBtn: "Create Now",
        cardImg:
          "/imgs/AnimationMaker/Animator_content_creator_a3c7c1a44c.webp",
      },
  ...
  let miniCarouselData = {
    ...
    mainHeading2: "AI animation generator",
    card: [
      {
        cardH: "Save time with AI animation maker",
        cardP:
          "Type your idea, set details like video length, platform, voiceover style, and get an AI generated animation video in no time.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "AI generated visuals",
        cardP:
          "Create animated videos with AI visuals on invideo AI v3.0 without switching between various tools.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "Edit with simple prompts",
        cardP:
          "Edit the AI generated animated videos with the magic box on invideo AI. Change accents, remove scenes, or add an intro with easy prompts.",
        icon: (
          <svg
            width="24"
            height="24"
    ...
    carousels: [
      {
        id: 1,
        name: "Prompt",
        disc: 'Choose "Create animated film" workflow, and fill out the details.',
      },
      {
        id: 2,
        name: "Generate",
      ...
      },
      {
        id: 3,
        name: "Edit",
        disc: 'Use the magic edit box to edit your video. Use commands like "delete scene," "change voiceover," and "accent." ',
      },
      {
        id: 4,
        name: "Publish",
  ...
  return (
    <>
      ...
      <MiniCarousel
        darkMode={darkMode}
        miniUpdateCarouselContent={miniUpdateCarouselContent}
        miniCarouselContent={miniCarouselContent}
      />
      <CommonPricing darkMode={darkMode} />
      <LargeCarousel
        darkMode={darkMode}
        updateLargeCarouselContent={updateLargeCarouselContent}
