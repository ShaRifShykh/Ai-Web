...
const LinkToVideo = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "Link to Video",
    headingPart2: "Generator",
    disc: "Convert URL to a full-fledged video with visuals, background music, subtitles, and voiceovers, within minutes.",
    button: "Convert Now",
    creditText: null,
  ...
  let cardData = {
    MHP1: "Convert link to video",
    MHP2: "with AI",
    cards: [
      {
        cardHeading: "Generate Al videos from URL",
        cardDisc:
          "Paste your link, choose settings like video length, platform, subtitles, voiceover accent, etc, and get AI-generated videos from your URL in no time.",
        cardBtn: "Create Now",
  ...
  let miniCarouselData = {
    ...
    mainHeading2: "URL to video converter",
    card: [
      {
        cardH: "Save time & resources",
        cardP:
          "Turn a link into a video with AI-generated visuals, saving time and simplifying video creation.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "No experience needed",
        cardP:
          "reate videos from a URL with no prior experience. Use AI to publish videos regularly and keep your audience engaged.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      },
      {
        ...
        cardP:
          "Add realistic AI voices to your videos in over 50 global languages.",
        icon: (
          <svg
            width="24"
            height="24"
