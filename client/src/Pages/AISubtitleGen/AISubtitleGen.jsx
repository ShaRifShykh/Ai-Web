...
const AISubtitleGen = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "AI",
    headingPart2: "Subtitle Generator",
    disc: "Generate subtitles with AI in 50+ global languages for videos created on invideo AI. Make a video with a voiceover in any language and add subtitles in any foreign language using invideo AI.",
    button: "Get started",
    creditText: "Trusted by 25mn+ users",
  ...
  let cardData = {
    MHP1: "AI video",
    MHP2: "subtitle generator",
    cards: [
      {
        cardHeading: "Subtitle styles",
        cardDisc:
          "Choose from bold subtitles with popping effects, clean subtitles, classic Hormozi style, comic subtitles, banger effect subtitles, and karaoke style word-by-word subtitles.",
        cardBtn: "Generate Now",
        cardImg: "/imgs/SubtitleGen/Frame_1214133755_a62e22fb82.webp",
      },
      {
        cardHeading: "Subtitles fonts",
        cardDisc:
          "Generate subtitles using fonts like Montserrat, Roboto, Arial, and Comic Sans. Just include them in your initial video prompt or use the Magic Edit box to make changes.",
        cardBtn: "Get started",
        cardImg: "/imgs/SubtitleGen/Frame_1214132857_ab4564030f.webp",
      },
    ],
  };
  useEffect(() => {
  ...
  let miniCarouselData = {
    mainHeading1: "Generate",
    mainHeading2: "free AI subtitles",
    card: [
      {
        cardH: "Increased retention numbers",
        cardP:
          "Subtitles improve video retention by providing textual support, benefiting non-native speakers as well to engage with the content till the end.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "Growing social media",
        cardP:
          "Subtitles boost social media growth by making videos accessible in any environment, enhancing viewer engagement, increasing watch time, and ensuring your message reaches a broader audience.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "Breaking language barriers",
        cardP:
          "Videos should be accessible to everyone, regardless of their challenges. This is where invideo's AI subtitle generator helps by breaking language barriers and making videos accessible through seamless transcription.",
        icon: (
          <svg
            width="24"
            height="24"
  ...
  let lcarouselconente = {
    MHP1: "How to generate",
    MHP2: "subtitle for a video?",
    carousels: [
      {
        id: 1,
        name: "Prompt",
        disc: "Prompt on invideo AI to create a video on your desired topic.",
      },
      {
        id: 2,
        name: "Generate",
        disc: 'Add the required language and the subtitle style in the prompt box along with other details & click "Generate now".',
      },
      {
        id: 3,
        name: "Edit",
        disc: "Change subtitle style & language with a simple text command on the edit magic box.",
      },
      {
        id: 4,
        name: "Publish",
