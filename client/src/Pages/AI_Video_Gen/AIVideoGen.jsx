...
const AIVideoGen = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "Generate AI videos",
    headingPart2: "from simple text prompts",
    disc: "Prompt your video idea and our Al video generator writes the script, adds visuals generated with AI, adds voiceovers, subtitles, music, etc. Create publish-worthy videos for any topic.",
    button: "Create now",
    creditText: null,
  ...
  let cardData = {
    MHP1: "AI video generator",
    MHP2: null,
    cards: [
      {
        cardHeading: "Generate Al videos without a learning curve",
        cardDisc:
          "Type your idea, add the specifics—like length, platform, voiceover accent and get AI generated videos that put your ideas into focus.",
        cardBtn: "Create Now",
        cardImg: "/imgs/VideoGen/Text_to_Video_e1c640e46c.webp",
      },
      {
        cardHeading: "Edit videos with a text prompt",
        cardDisc:
          "Edit your videos with the magic box on invideo AI. Give simple commands like change the accent, delete scenes or add an funny intro and watch your videos come to life.",
        cardBtn: "Create Now",
        cardImg: "/imgs/VideoGen/Export_0311407e78.webp",
      },
    ],
  };
  useEffect(() => {
  ...
  let miniCarouselData = {
    ...
    mainHeading2: "Al video generator",
    card: [
      {
        cardH: "Al powered scripts to save time",
        cardP:
          "Making engaging videos with AI generated visuals. Tailored scripts for any video topic, saving hours of valuable time and taking the hassle out of video creation.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "Realistic AI Voices",
        cardP:
          "Brings your videos to life by grasping the emotion behind every word, adding human-sounding Al voiceovers in over 50 languages.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      },
      {
        ...
        cardP:
          "Plan and execute a video content strategy that will significantly increase your exposure, awareness and engagement. Publish videos frequently with Al to keep your viewers engaged.",
        icon: (
          <svg
            width="24"
            height="24"
  ...
  let lcarouselconente = {
    MHP1: "How to generate videos",
    MHP2: "with invideo AI?",
    carousels: [
      {
        id: 1,
        name: "Prompt",
      ...
      },
      {
        id: 3,
        name: "Edit",
        disc: "Use edit Magic Box to make edits to your video. Use commands like, delete scene, change voiceover, accent, etc. Publish Export the video & share ",
      },
      {
        id: 4,
        name: "Publish",
