...
const AIClipGen = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "AI",
    headingPart2: "Clip Generator",
    disc: "Create video clips for YouTube, Instagram, and TikTok with simple text prompts. Just type in your idea to generate clips with generative media, voiceovers, background music, SFX, etc.",
    button: "Create Now!",
  ...
  let cardData = {
    MHP1: "Text to video clip generator",
    MHP2: null,
    cards: [
      {
        cardHeading: "Make clips from text",
        cardDisc:
          "Prompt invideo AI with your video clip idea, add details about the characters and other elements, and generate a video clip within minutes.",
        cardBtn: "Create Now",
        cardImg: "/imgs/AiClipGen/Frame_1214132517_06d6d08c05.webp",
      },
      {
        cardHeading: "Edit clips with a text prompt",
        cardDisc:
          "Edit your video clips with the magic box on invideo AI. Give simple commands like change the accent, delete scenes, change language, and watch your AI video clips come to life.",
        cardBtn: "Create Now",
        cardImg: "/imgs/AiClipGen/Frame_Editor_b95e77d1c4.webp",
      },
    ],
  };
  useEffect(() => {
  ...
  let miniCarouselData = {
    mainHeading1: "Use invideo AI clip maker to",
    mainHeading2: "keep your audience engaged",
    card: [
      {
        cardH: "Short video clips for marketers",
        cardP:
          "Create promos, ads, and other short videos for social media using our AI clip generator.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      },
      {
        ...
        cardP:
          "Our voice engine adds ultra-realistic voices to your video clips, available in 50+ languages.",
        icon: (
          <svg
            width="32"
            height="32"
  ...
  let lcarouselconente = {
    MHP1: "How to create a",
    MHP2: "video clip with invideo AI",
    carousels: [
      {
        id: 1,
        name: "Prompt",
