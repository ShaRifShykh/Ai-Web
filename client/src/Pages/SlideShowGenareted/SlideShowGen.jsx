...
const SlideShowGen = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "AI ",
    headingPart2: "Slideshow Maker",
    disc: "Create slideshow videos in minutes with simple text prompts. Our AI automatically writes the script, creates scenes, adds generative media, voiceovers, subtitles, SFX, and gives you a complete video.",
    button: "Create Now!",
  ...
  let cardData = {
    MHP1: "AI slideshow generator with",
    MHP2: "music and effects",
    cards: [
      {
        cardHeading: "Create AI slideshows",
        cardDisc:
          "Generate AI slideshows from simple prompts. Make slideshows on any topic with just an idea.",
        cardBtn: "Try now!",
        cardImg: "/imgs/SlideShow/Export_76c76992c7.webp",
      },
      {
        cardHeading: "No learning curve needed",
        cardDisc:
          "Creating AI slideshows with invideo AI is as easy as typing an idea.",
        cardBtn: "Try now!",
        cardImg: "/imgs/SlideShow/Export_c772bd0156.webp",
      },
    ],
  };
  useEffect(() => {
  ...
  let miniCarouselData = {
    mainHeading1: "Use the power of AI generated",
    mainHeading2: "slideshow videos",
    card: [
      {
        cardH: "Enhance your business communications",
        cardP:
          "Turn company updates, pitch decks, proposals, and more into slideshow videos to enhance the impact of your communications.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "Impress potential new clients",
        cardP:
          "Use slideshow videos to present yourself and your work to clients. They’re easier to share and more engaging than slide decks.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "Create more content, more consistently",
        cardP:
          "Make slideshow videos with invideo AI in minutes. Convert your regular content into AI slideshows and stay consistent with your content across all platforms.",
        icon: (
          <svg
            width="24"
            height="24"
  ...
  let lcarouselconente = {
    MHP1: "How to generate a",
    MHP2: "slideshow with invideo AI?",
    carousels: [
      {
        id: 1,
        name: "Prompt",
        disc: "Choose a workflow from the dropdown, describe your slideshow video idea, and hit generate now!",
      },
      {
        id: 2,
        name: "Generate",
      ...
      },
      {
        id: 3,
        name: "Edit",
        disc: "Use edit Magic Box to make edits to your video. Use commands like, delete scene, change voiceover, accent, etc",
      },
      {
        id: 4,
        name: "Publish",
