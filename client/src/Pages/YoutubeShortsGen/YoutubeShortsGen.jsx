...
const YoutubeShortsGen = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "AI YouTube",
    headingPart2: "Shorts Generator",
    disc: "Create faceless short videos for YouTube from simple text prompts within minutes. AI writes the script, creates scenes, adds generative media, voiceovers, subtitles, SFX and gives you a complete video.",
    button: "Create Youtube Shorts!",
    creditText: "Trusted by 25M+ users worldwide",
  ...
  let cardData = {
    MHP1: "I-powered YouTube",
    MHP2: "shorts maker",
    cards: [
      {
        cardHeading: "No learning curve needed",
        cardDisc:
          "Creating faceless YT shorts with invideo AI is as easy as typing an idea.",
        cardBtn: "Make a Short Video!",
        cardImg: "/imgs/YoutubeShortsGen/Frame_Editor_1012b209a3.webp",
      },
      {
        cardHeading: "Make faceless YT shorts on any topic",
        cardDisc:
          "Create short films, make ads for your business or create a trailer for your movie easily. Create faceless YouTube shorts on any topic in any style.",
        cardBtn: "Turn Ideas into YT shorts",
        cardImg: "/imgs/YoutubeShortsGen/Frame_Editor_5df6b689bf.webp",
      },
    ],
  };
  useEffect(() => {
  ...
  let miniCarouselData = {
    mainHeading1: "Use the full potential of",
    mainHeading2: "AI YouTube shorts generator",
    card: [
      {
        cardH: "Al powered scripts to save time",
        cardP:
          "Faceless shorts generator creates engaging, tailored scripts automatically for any YouTube shorts topic, saving hours of valuable time and taking the hassle out of short video creation.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      },
      {
        ...
        cardP:
          "Brings your short videos to life with voiceovers that grasp the emotion behind every word, in any language and accent.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      },
      {
        ...
        cardP:
          "Create, edit and publish videos more frequently with Al and keep your audience entertained.",
        icon: (
          <svg
            width="24"
            height="24"
  ...
  let lcarouselconente = {
    ...
    MHP2: "faceless YT shorts with AI?",
    carousels: [
      {
        id: 1,
        name: "Prompt",
...
export default YoutubeShortsGen;
