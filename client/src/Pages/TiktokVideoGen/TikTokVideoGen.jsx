...
const TikTokVideoGen = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "AI TikTok",
    headingPart2: "Video Generator",
    disc: "reate trendy TikTok videos with our AI TikTok video generator. Invideo AI turns your scripts into fully-fledged videos, adding voiceovers, subtitles, music, and sound effects to complete your TikTok content in minutes.",
    button: "Create Now!",
  ...
  let cardData = {
    MHP1: "Create viral",
    MHP2: "AI TikTok videos",
    cards: [
      {
        cardHeading: "Easily make TikTok videos with AI",
        cardDisc:
          "Generate TikTok videos from simple prompts with our AI TikTok video generator. Make TikTok videos on any topic with just an idea.",
        cardBtn: "Try Now!",
        cardImg: "/imgs/TiktokGen/Frame_1214132517_794e2c7305.webp",
      },
      {
        cardHeading: "Create & edit trending TikTok videos in any style",
        cardDisc:
          "Workflows simplify your process by guiding you through easy-to-use forms. Explore workflows to create and edit trending TikTok videos in over 50 styles",
        cardBtn: "Try Now!",
        cardImg: "/imgs/TiktokGen/Export_55b7ecaca7.webp",
      },
    ],
  };
  useEffect(() => {
  ...
  let miniCarouselData = {
    ...
    mainHeading2: "TikTok video generator",
    card: [
      {
        cardH: "Al powered scripts to save time",
        cardP:
          "Make engaging TikTok videos with AI-generated visuals. Tailored scripts for any video topic, saving hours of valuable time and taking the hassle out of video creation.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      },
      {
        ...
        cardP:
          "Bring your TikTok videos to life by grasping the emotion behind every word, adding human-sounding Al voiceovers in over 50 languages.",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      },
      {
        ...
        cardP:
          "Plan and execute a video content strategy that will significantly increase your exposure, awareness, and engagement. Publish TikTok videos frequently with Al to keep your viewers engaged.",
        icon: (
          <svg
            width="24"
            height="24"
  ...
  let lcarouselconente = {
    MHP1: "HHow to create",
    MHP2: "TikTok video with invideo AI?",
    carousels: [
      {
        id: 1,
        name: "Prompt",
      ...
      },
      {
        id: 3,
        name: "Edit",
        disc: "Use the magic edit box to make edits to your video. Use commands like, delete scene, change voiceover, accent, etc.",
      },
      {
        id: 4,
        name: "Publish",
