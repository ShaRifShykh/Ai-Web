...
const MobileApp = ({ darkMode }) => {
  return (
    ...
    >
      <div className="max-w-[1450px] font-roboto tracking-wide text-center xs:py-10 px-5 md:py-32  mx-auto">
        <h2 className="lg:text-[4vw] md:text-[5vw] xs:text-[6vw] font-semibold gradient-text">
          Intellivid AI{" "}
          <span
            id=""
        ...
        <div
          id="modileAppPoster"
          className="md:mt-24 xs:mt-5 w-full rounded-xl grid md:grid-cols-2 sm:gap-5 md:gap-20 xl:gap-32"
        >
          <div className="lg:px-20 sm:px-10 xs:px-5 xs:py-5 md:py-10 text-start">
            <h2 className="xl:text-[4.5vw] xs:text-[6.6vw] xs:leading-[7vw] md:text-[5.6vw] md:leading-[6vw] text-white text-start leading-[4.8vw] font-bold tracking-wide">
              Get the mobile app
            </h2>
            <p className="md:text-[1.5vw] xs:text-[3vw] xs:my-3 lg:mt-8 text-gray-300">
