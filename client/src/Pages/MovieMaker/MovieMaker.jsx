...
const MovieMaker = ({ darkMode, toggleMode }) => {
  ...
  let intellvidHeroContent = {
    headingPart1: "Make full-length movies",
    headingPart2: "with AI",
    disc: "Bring you script to life with our AI movie generator. Invideo AI turns your movie script into a full-length movie with Al. It generates characters, adds voiceovers, subtitles, music and SFX to give you complete movie.",
    button: "Create Movie Now",
    creditText: null,
  ...
  let cardData = {
    ...
    cards: [
      {
        cardHeading: "Create animated movies with AI",
        cardDisc:
          "Try your hand a creating a film in Anime or Disney Pixar style with our online AI movie maker  ",
        cardBtn: "Create Now",
        cardImg: "/imgs/MovieMaker/New_Flows_1_7664034758.webp",
      },
      {
        cardHeading: "Edit movies with a text prompt",
        cardDisc:
          "Edit your movies with the magic box on invideo AI. Give simple commands like change the accent, delete scenes or add an funny intro and watch your videos come to life.",
        cardBtn: "Create Now",
        cardImg: "/imgs/MovieMaker/Export_0311407e78.webp",
      },
    ],
  };
  useEffect(() => {
  ...
  let miniCarouselData = {
    mainHeading1: "The only movie creator",
    mainHeading2: "you will ever need",
    card: [
      {
        cardH: "Make movies with AI",
        cardP:
          "Making movies with just a single prompt. AI is truly incredible",
        icon: (
          <svg
            width="32"
            height="32"
      ...
      {
        cardH: "Best in class voiceovers",
        cardP:
          "Realistic sounding the voiceovers! The range of voices and accents are just amazing.",
        icon: (
          <svg
            width="32"
            height="32"
  ...
  let lcarouselconente = {
    MHP1: "How to make a",
    MHP2: "movie using invideo?",
    carousels: [
      {
        id: 1,
        name: "Prompt",
        disc: "Choose a workflow from the dropdown, and paste your link. Share details about how you want your video to be.",
      },
      {
        id: 2,
        name: "Generate",
